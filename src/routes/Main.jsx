...
export default function Main() {
  ...
  // ⭐ Auto-run when shared text is passed from /share
  useEffect(() => {
    const shared = localStorage.getItem('sharedText');

    if (shared && !hasRunRef.current) {
    ...
    // Load last output if no shared text
